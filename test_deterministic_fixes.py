...
SyntaxError: expected ':'''',
        ...
        fixed_line = fixed_content.split('def broken_function')[1].split('\n')[0].strip()
...
def test_fstring_escape_fix():
    """Test deterministic f-string escape fix"""
...
SyntaxError: unexpected character after line continuation character''',
        ...
        fixed_msg = 'f"Hello {name}"' if 'f"Hello {name}"' in fixed_content else 'No change'
...
def test_indentation_fix():
    """Test deterministic indentation fix"""
...
IndentationError: expected an indented block''',
        ...
        fixed_msg = '        print' if '        print' in fixed_content else 'No change'
        print(f"   Fixed:    {fixed_msg}")
...
def test_utc_now_fix():
    """Test deterministic _utc_now fix"""
