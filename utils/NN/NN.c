...
(base) samueldasari @Samuels - MacBook -
    Air NN % ls MEMORY NEAT.c NEAT.md NN.h TOKENIZER.h TRANSFORMER.h MUZE
                 NEAT.h NN.c TOKENIZER.c TRANSFORMER.c(base) samueldasari
             @Samuels -
    MacBook -
    Air NN % cat NN.h &&cat NN.c
#ifndef NN_H
#define NN_H
