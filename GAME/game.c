...
static int save_world_to_disk(const char *world_name) {
  ...
  h.agent_count = 0;
  h.pickup_count;     // number of alive pickups written
  h.projectile_count; // number of alive projectiles written
...
// ------------------------------------------------------------
// Mob AI (rewrite)
//  - passive: wander, flee player/agents if close or recently hit (aggro_timer)
