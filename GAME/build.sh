...
cc -g -O0 game.c game_impl.c ../utils/NN/NN/NN.c ../utils/NN/TRANSFORMER/TRANSFORMER.c ../utils/NN/NEAT/NEAT.c ../utils/NN/CONVOLUTION/CONVOLUTION.c $(find ../RL_AGENT -type f -name '*.c' -print | grep -v test | sort -u | tr '\n' ' ') $(find ../utils/NN/MUZE -type f -name '*.c' -print | sort -u | tr '\n' ' ') $(find ../SAM -type f -name '*.c' -print | sort -u | tr '\n' ' ') -I../utils/NN/NN -I../utils/NN/CONVOLUTION -I../utils/NN/MUZE -I../SAM -I../RL_AGENT -I../utils/NN/TRANSFORMER -I../utils/NN/NEAT -I../utils/Raylib/src -I../utils/SDL/include -I../utils/SDL_ttf/include -F../utils/SDL/build -framework SDL3 -L../utils/SDL_ttf/build -lSDL3_ttf -Wl,-rpath,../utils/SDL/build -Wl,-rpath,../utils/SDL_ttf/build ../utils/Raylib/src/libraylib.a -framework Cocoa -framework IOKit -framework CoreVideo -pthread -lm -framework OpenGL -arch arm64 -o game 2>&1 | tee "$LOG_FILE"
